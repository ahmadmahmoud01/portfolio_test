        ...
        <div class="container ">
          {{-- <div class="row"> --}}
            <div class="col-md-10">
                ...
                <form action='{{url("socials/update/$social->id")}}' method="POST">
                    @csrf
                    {{-- <input type="text" name="social_name" placeholder=""> --}}
                    <div class="form-group row">
                        <label for="" class="col-sm-2 col-form-label">Social Name</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="social_name" id="social_name" placeholder="social name" value="{{$social->social_name}}">
                        </div>
